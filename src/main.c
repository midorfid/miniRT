...
int main(void) {
    ...
    lens.defocus_angle = 0.0; // Variation angle of rays through each pixel
    ...
    material_t *noisy = mt_lambertian_new_with_tex(perlin_new(4.0));

    hittable_list_add(world, sphere_new(point3(0,-1000,0), 1000, noisy));
    hittable_list_add(world, sphere_new(point3(0,2,0), 2, material_claim(noisy)));
